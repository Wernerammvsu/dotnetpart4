...
namespace BookingPlatform.Domain.Service
{
    public class BookingService : IBookingService
    {
        ...
        public async Task<IEnumerable<Booking>> FindBookingsWithDefaultRoomAsync()
        {
        ...
        public async Task<IEnumerable<Booking>> FindAllActiveAsync()
        {
